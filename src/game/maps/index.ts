...
export const maps: readonly MapDefinition[] = [
  ...
  },
  {
    ...
    title: 'Snagov',
    description:
      'The Snagov county map, converted from the original .MAP file.',
    mapSource: `${import.meta.env.BASE_URL}maps/snagov.tmj`,
    // No spawn points yet, so only `empty` (allowed on every map) applies.
    allowedScenarioIds: [],
  },
  {
  ...
  },
  {
    ...
    title: 'Giurgiu',
    description:
      'The Giurgiu county map, converted from the original .MAP file.',
    mapSource: `${import.meta.env.BASE_URL}maps/giurgiu.tmj`,
    // No spawn points yet, so only `empty` (allowed on every map) applies.
    allowedScenarioIds: [],
  },
  {
    id: 'tirgo',
    title: 'Tirgo',
    description: 'The Tirgo county map, converted from the original .MAP file.',
    mapSource: `${import.meta.env.BASE_URL}maps/tirgo.tmj`,
    // No spawn points yet, so only `empty` (allowed on every map) applies.
    allowedScenarioIds: [],
  },
  {
    ...
    title: 'Cuerta',
    description:
      'The Cuerta county map, converted from the original .MAP file.',
    mapSource: `${import.meta.env.BASE_URL}maps/cuerta.tmj`,
    // No spawn points yet, so only `empty` (allowed on every map) applies.
    allowedScenarioIds: [],
  },
  {
